...
import CellLink from "../ServicesIndex/CellLink";
...
function ServiceNavItem({ id, name, url }: any) {
    return (
        <NavLink
            ...
            className={({ isActive }) => (
                `text-xs px-1 pb-3.5 whitespace-nowrap border-b ${isActive ? "text-[#252C32] border-[#000] font-semibold active-class" : "font-medium border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700"}`
            )}
        >
            {name}
        </NavLink>
        ...
        <Container>
            ...
            <section className="flex justify-between items-center mb-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-6">
                            <div className="flex items-center space-x-2 text-[#48535B]">
                                <span className="text-xs">docker/welcome-to-docker:latest</span>
                ...
                <div className="flex items-center space-x-10">
                    ...
                    <CellLink label="https://sgshdihds-ishdis.exopods.run" />
            ...
            <section>
                <div className="border-b-2 border-gray-200 pb-1.5 mb-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                        <Input placeholder="Search logs" type="text" className={`bg-[#F5F5F7] py-2 px-12 pl-10 h-9 border-0 ${isSearch ? "" : "hidden opacity-0"} `} iconLeft={`
                            <svg class=${isSearch ? "" : "hidden opacity-0"}  width="20" height="21" viewBox="0 0 20 21" fill="none">
